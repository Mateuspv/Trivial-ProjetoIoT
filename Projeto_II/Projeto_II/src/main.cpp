...
#define WIFI_PASS "12345678"  // Senha da rede Wi-Fi
#define APP_KEY ""            // Chave da aplicação SinricPro
#define APP_SECRET ""         // Segredo da aplicação SinricPro
#define SWITCH_ID ""          // ID do dispositivo no SinricPro

// Define o tempo da porta serial
#define BAUD_RATE 9600

// Define os pinos GPIO para o botão e o relé
#define BUTTON_PIN 0  // GPIO para o botão (inverso: LOW = pressionado, HIGH = liberado)
#define RELE_PIN 5    // GPIO para o relé
...
bool onPowerState(const String &deviceId, bool &state){
  ...
  // Define o estado do relé com base no estado do dispositivo (Operador Ternário)
